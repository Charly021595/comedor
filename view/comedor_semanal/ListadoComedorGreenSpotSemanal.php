...
<body class="hold-transition skin-blue sidebar-mini sidebar-collapse">
									...
									<div class="panel-body">
										<section id="Industria" class="CeroPadCeroMar">
											...
											<div class="form-group row" id="divIDVisita">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" maxlength="6" id="txtNumEmpleadoLogeado" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
												</div>
											</div>
											<div class="form-group row" id="divIDVisita">
   ...
   <!-- <script src="libraries/datatables/jquery.dataTables.min.js"></script>-->
    ...
    <script src="../../javascript/ListadoComedorGreenSemanal.js?t=<?=time()?>"></script>
