  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
            <div class=" container col-xs-12">
                <div class="box">
					<div class="box-header" >
					    ...
					    <form action="" method="POST" id="form_comedor_finalizados">
							...
							<div class="col-md-4 col-xs-12">
								<div class="form-group row">
									<button type="button" id="buscar_finalizados" class="btn btn-primary btn-lg btn-block">Buscar listado</button>
								</div>
							</div>
						</form>

						<!-- -->
						<div id="filtros_plato_finalizados" style="display:none;" class="col-md-8 col-xs-12">
						   <div class="form-group row">
								<label for="lblNombreVisita_plato_finalizados" class="col-sm-3 col-form-label">Filtrar por Id Conciliación:</label>
								<div class="col-sm-6">
								  <input type="text" class="form-control" maxlength="12" id="txtNumeroConciliacion_plato_finalizados">
								</div>
							</div>
						</div>
						<!-- -->
						<div style="text-align:right; display:none;" id="boton_descarga_excel_finalizados">
							<button id="btn_conciliar_comedor_finalizados" class="btn btn-primary" onclick="DescargarTablaFinalizados()">Exportar Excel</button>
						</div>
					</div>
                </div>
            </div>
		...
		<div id="modal_detalles_primer" data-backdrop="static" data-keyboard="false" tabindex="-1" class="modal fade" role="dialog" ria-labelledby="largeModal" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				...
				<div class="modal-content">
					<div id="modal_header_detalles_primer" class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><i id="cross_cerrar" class="fa fa-times" aria-hidden="true"></i></button>
						<h4 class="modal-title" id="titulo_modal_finalizados_primer_detalle">Detalles</h4>
					</div>
					<div class="modal-body">
						...
						<div class="panel panel-default">
							<div class="panel-body">
								<div class="row">
									<div id="filtro_pirmer_detalle_finalizado" class="col-md-8 col-xs-12">
									</div>
								</div>
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-12">
										<div style="text-align:right;" id="boton_descarga_excel_primer_detalle_finalizados">
										</div>
									</div>
								</div>
							</div>
		...
		<!-- Modal ver detalles -->
		<div id="modal_detalles_segundo" data-backdrop="static" data-keyboard="false" tabindex="-1" class="modal fade" role="dialog" ria-labelledby="largeModal" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<!-- Modal content-->
				<div class="modal-content">
					<div id="modal_header_detalles_segundo" class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><i id="cross_cerrar" class="fa fa-times" aria-hidden="true"></i></button>
						<h4 class="modal-title" id="titulo_modal_finalizados_segundo_detalle">Detalles</h4>
					</div>
					<div class="modal-body">
						<div class="panel panel-default">
							<div class="panel-body">
								<!-- Aqui se cargaran las tablas con los detalles de los Platillos -->
								<div class="col-xs-12 col-sm-12 col-md-12 scroll_pedido_tabla_detalles" id="mostrar_tabla_segundo_detalle_finalizados">
					...
					<div class="modal-footer">
						<div class="d-flex flex-row-reverse" id="agregar_botones_segundo_detalle_finalizados">
						</div>
					</div>
				</div>
			</div>
...
<script src="../../javascript/ListadoComedorFinalizados.js?t=<?=time()?>"></script>
