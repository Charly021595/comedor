                ...
                <div class="box">
					<div class="box-header" >
						...
						<div style="text-align:right; display:none;" id="boton_descarga_excel_green">
							<button id="btn_conciliar_comedor_green_spot" class="btn btn-primary" onclick="DescargarTablaGreen()"><label style="display: none;" for="" id="lbl_btn_conciliar_gs">Conciliar</label><img id="cargando_conciliar_gs" class="gif_cargando_btn" src="../../assets/img/loading.gif" style="display:none;"></button>
						</div>
