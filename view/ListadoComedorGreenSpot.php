  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li>
			<a href="comedor_semanal/ListadoComedorGreenSpotSemanal.php">
			<img src="../assets/img/microsoftteams_image__9__mR8_icon.ico"> <span> Green Spot</span>
			<span class="pull-right-container">
		...
		<li>
			<a href="comedor_semanal/ListadoComedorSemanal.php">
			<img src="../assets/img/microsoftteams_image__9__mR8_icon.ico"> <span>Comedor Plato Express</span>
			<span class="pull-right-container">
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
			  <div class="modal-header" style="background: #36AD52;">
				<h4 class="modal-title" id="exampleModalLongTitle" style="color: #FFFFFF;">Crear pedido.</h4>
			  ...
			  <div class="modal-body">
					...
					<section id="Industria" class="CeroPadCeroMar ">
						...
						<div class="form-group row" id="divIDVisita">
							...
							<div class="col-sm-8">
							  <input type="text" class="form-control" id="txtNumEmpleadoLogeado">
							</div>
						 </div>
						 <div class="form-group row" id="divIDVisita">
							<button type="button" class="btn btn-primary  btn-block ValidaBoton" onclick="BuscarEmpleadoLogeado();" id="GuardarOrden" >Buscar Empleado</button>
						 </div>
						 <div class="form-group row" id="divIDVisita">
...
<script src="https://cdn.datatables.net/1.10.24/js/jquery.dataTables.min.js"></script>
   <!-- <script src="libraries/datatables/jquery.dataTables.min.js"></script>-->
    ...
    <script src="../javascript/ListadoComedorGreen.js?t=<?=time()?>"></script>
